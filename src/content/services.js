...
const SERVICES_CONTENT = {
  "academic-consultations": {
    ...
    ar: {
      title: "الاستشارة الأكاديمية والتوجيه المنهجي",
      intro:
        "تتيح هذه الخدمة للباحثين فرصة الاستفادة من توجيه علمي متخصص يساعدهم على ضبط أسئلة البحث، وتحديد المتن الوثائقي المناسب، واختيار المسارات المنهجية الملائمة لطبيعة الموضوع ومصادره. وهي خدمة موجهة إلى من يحتاج إلى قراءة أولية لمشروعه، أو إلى ترتيب مادته العلمية، أو إلى فهم أفضل لإمكانات الأرشيف والمكتبة الرقمية داخل المؤسسة.",
      heroImage: null,
      bodySections: [
        {
          title: "مفهوم الخدمة",
          paragraphs: [
            "تقوم الاستشارة الأكاديمية على حوار علمي موجّه بين الباحث وفريق المؤسسة، بهدف فهم موضوع البحث، وتحديد حاجاته الوثائقية والمنهجية، واقتراح مسارات عملية للتعامل مع المادة المتاحة.",
            "لا تعوض هذه الخدمة عمل الباحث، بل تساعده على ترتيب أولوياته، وتجنب التشتت في المصادر، وربط أسئلته البحثية بالوثائق والدراسات المناسبة."
          ]
        },
        {
          title: "ما الذي تقدمه للباحث؟",
          paragraphs: [
            "تساعد الخدمة على تحديد المجموعات أو الوثائق أو الدوريات الأقرب إلى موضوع البحث، واقتراح كلمات مفتاحية ومسارات بحثية يمكن اعتمادها داخل المكتبة الرقمية.",
            "كما تتيح للباحث مراجعة أولية لمنهجيته، وصياغة أسئلته، وترتيب خطواته المقبلة، خاصة في المراحل الأولى من إعداد المقالات أو الرسائل أو الدراسات."
          ]
        },
        {
          title: "آلية الاستفادة",
          paragraphs: [
            "يمكن للباحث التواصل مع المؤسسة مرفقاً ملخصاً موجزاً لموضوعه، وبياناً لطبيعة الدعم العلمي الذي يحتاجه.",
            "تتم دراسة الطلب وتوجيه الباحث نحو الاستشارة أو المصدر أو المسار الأنسب، بحسب طبيعة الموضوع وتوفر المادة العلمية داخل المنصة."
          ]
        }
      ]
    }
  ...
  "researcher-support": {
    ...
    ar: {
      title: "مواكبة الباحثين وبرامج التكوين",
      intro:
        "تعمل المؤسسة على مواكبة الباحثين والطلبة في مساراتهم العلمية من خلال أنشطة تكوينية وتوجيهية تساعد على تطوير أدوات البحث، وتحسين التعامل مع الوثيقة، وتنظيم المادة، والانتقال من جمع المصادر إلى بناء معرفة تاريخية قابلة للتحليل والنشر.",
      heroImage: null,
      bodySections: [
        {
          title: "مفهوم الخدمة",
          paragraphs: [
            "لا تقتصر مواكبة الباحثين على تقديم جواب سريع عن سؤال جزئي، بل تتجه إلى دعم مسار البحث في مراحله المختلفة: من بناء الإشكالية، إلى جمع المادة، ثم تحليلها وتنظيمها وتقديمها في صيغة علمية.",
            "وتستند هذه المواكبة إلى رؤية تجعل من التكوين المنهجي، وحسن استعمال المصادر، واحترام قواعد التوثيق، عناصر أساسية في جودة البحث."
          ]
        },
        {
          title: "مجالات المواكبة",
          paragraphs: [
            "تشمل المواكبة ورشات ومواد توجيهية حول منهجية البحث، قراءة الوثائق، إعداد البيانات الوصفية، تنظيم المراجع، وأخلاقيات التعامل مع المادة التاريخية والوثائقية.",
            "كما يمكن أن تشمل دعماً في فهم بنية المكتبة الرقمية، واستعمال أدوات البحث المتاحة، وربط الوثائق بسياقاتها التاريخية والمعرفية."
          ]
        },
        {
          title: "صلتها بمسار البحث",
          paragraphs: [
            "تساعد هذه الخدمة الباحث على الانتقال من مرحلة البحث العفوي عن المصادر إلى مرحلة العمل المنظم القائم على السؤال، والمنهج، والتحقق.",
            "وهي تنسجم مع رسالة المؤسسة في جعل الوثيقة مادة حية للبحث، لا مجرد صورة محفوظة أو ملف رقمي معزول عن سياقه."
          ]
        }
      ]
    }
  ...
  "archive-search": {
    ...
    ar: {
      title: "البحث في المكتبة الرقمية والأرشيف الوثائقي",
      intro:
        "تتيح هذه الخدمة للباحثين والقراء استكشاف محتويات المكتبة الرقمية والأرشيف الوثائقي للمؤسسة عبر أدوات بحث منظمة تساعد على الوصول إلى الكتب، والدوريات، والوثائق، والمخطوطات، والمواد العلمية المرتبطة بتاريخ طنجة وشمال المغرب. وهي امتداد عملي لرسالة المؤسسة في تقريب المصادر، وتنظيم المعرفة، وتيسير القراءة العلمية للوثيقة.",
      heroImage: null,
      bodySections: [
        {
          title: "مفهوم الخدمة",
          paragraphs: [
            "تقوم هذه الخدمة على تمكين المستخدم من البحث داخل رصيد رقمي منظم، يضم مواد علمية ووثائقية مختلفة، مع الاعتماد على بيانات وصفية تساعد على فهم طبيعة كل مادة وسياقها.",
            "ولا يقتصر البحث هنا على الوصول السريع إلى نتيجة، بل يهدف إلى مساعدة الباحث على بناء مسار قراءة يربط بين الموضوع، ونوع المصدر، والفترة التاريخية، والمؤلف أو الجهة المنتجة للمادة."
          ]
        },
        {
          title: "إمكانات البحث والوصول",
          paragraphs: [
            "يمكن للمستخدم البحث باستعمال الكلمات المفتاحية، أو تصفح المواد بحسب الموضوع، أو النوع، أو اللغة، أو الفترة الزمنية، وفق ما توفره المنصة من بيانات وفهارس.",
            "وتساعد المعاينات والبيانات المختصرة على اختيار المادة المناسبة قبل الانتقال إلى قراءتها أو إدراجها ضمن مسار البحث."
          ]
        },
        {
          title: "صلتها برسالة المؤسسة",
          paragraphs: [
            "ترتبط هذه الخدمة مباشرة بمشروع المؤسسة في صيانة الوثيقة وإتاحتها ضمن فضاء رقمي منظم، يراعي شروط الفهرسة، والوضوح، واحترام السياق التاريخي للمادة.",
            "ومن خلال المكتبة الرقمية والبحث المتقدم، تتحول المادة الوثائقية من أرشيف ساكن إلى مورد معرفي قابل للاستعمال الأكاديمي، وخدمة الباحثين والمهتمين بتاريخ المغرب وشماله."
          ]
        }
      ]
    }
