...
export const foundationIntroContent: Record<Locale, FoundationIntroContent> = {
  ...
  ar: {
    intro: [
      ...
      "تسعى المؤسسة، امتداداً لمسيرة الدكتور عبد العزيز خلوق التمسماني العلمية، إلى ترسيخ ثقافة الحفظ والتوثيق والنشر والتعاون الأكاديمي، حتى تبقى المعرفة التاريخية مورداً حياً ومتجدداً للأجيال القادمة."
    ],
    tabs: {
      mission: [
        "حماية وإبراز المجموعات العلمية والتاريخية الخاصة بالمغرب ومنطقة البحر الأبيض المتوسط.",
