...
const aboutDoctorTopContent: Partial<Record<Locale, AboutDoctorTopContent>> = {
  ...
  ar: {
    hero: {
      ...
      subtitle:
        "كرّس مسار توظيف الوثيقة والأرشيف لفهم تاريخ شمال المغرب في بيئته الوطنية ومحيطه الدوالي، وإعادة قراءة الذاكرة التاريخية بروح نقدية ومنهجية.",
      ...
      intro: [
        ...
        "من طنجة، عاصمة البوغاز، ومن حي المصلى تحديدا، تشكل وعيه الأول بالقراءة والمعرفة، قبل أن يتسع أفقه عبر تكوين عصامي متعدد اللغات والمصادر."
      ],
      ctaLabel: "قراءة السيرة الكاملة (PDF)"
    },
    formation: {
