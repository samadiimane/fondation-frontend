...
const LOCALE_LOADERS: Record<Locale, () => Promise<Array<Record<string, unknown>>>> = {
  ar: () =>
    Promise.all([
      ...
      import("./ar/assistant.json").then((module) => module.default),
      import("./ar/publishing.json").then((module) => module.default),
      ...
      import("./ar/library-publications.json").then((module) => module.default),
  ...
  en: () =>
    Promise.all([
      ...
      import("./en/assistant.json").then((module) => module.default),
      import("./en/publishing.json").then((module) => module.default),
      ...
      import("./en/library-publications.json").then((module) => module.default),
  ...
  es: () =>
    Promise.all([
      ...
      import("./es/assistant.json").then((module) => module.default),
      import("./es/publishing.json").then((module) => module.default),
      ...
      import("./es/library-publications.json").then((module) => module.default),
  ...
  fr: () =>
    Promise.all([
      ...
      import("./fr/assistant.json").then((module) => module.default),
      import("./fr/publishing.json").then((module) => module.default),
      ...
      import("./fr/library-publications.json").then((module) => module.default),
